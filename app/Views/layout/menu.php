...
<li><a class="nav-link" href="<?= site_url(); ?>"><i class="fas fa-square"></i> <span>Dashboard</span></a></li>
<li><a class="nav-link" href="<?= site_url('gawe'); ?>"><i class="fas fa-square"></i> <span>Gawe / Acara</span></a></li>
<li class="nav-item dropdown">
  <a href="#" class="nav-link has-dropdown"><i class="far fa-address-book"></i><span>Dashboard</span></a>
