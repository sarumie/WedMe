      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= site_url(); ?>">WeddMe</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= site_url(); ?>">wM</a>
          </div>
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="https://github.com/sarumie/WedMe" class="btn btn-primary btn-lg btn-block btn-icon-split">
              <i class="fab fa-github"></i> Link Repository
            </a>
          </div>
          <!-- <div class="mt-4 mb-4 p-3 hide-sidebar-mini text-center">
            Template by <a href="https://github.com/stisla/stisla"><b>Stisla</b></a>
          </div> -->
        </aside>
      </div>
